...
# Seperate GSE155249_norm into control and COVID-1 group
control = subset(GSE155249_norm, subset = group == "Control")
COVID_19 = subset(GSE155249_norm, subset = group == "COVID-19")
...
# This is the end of the Cell-cell Communication Prediction in GSE155249
#################################################################################################################
