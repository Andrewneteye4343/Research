...
interested_cells = subset(x = GSE149878_norm, subset = label == "CD14-Mo" | label == "CD14CD16-Mo" | label == "PF-M" | label == "PF-M-like")
...
comparisons <- list(c("CD14-Mo","PF-M"), c("CD14CD16-Mo","PF-M"), c("PF-M-like","PF-M"))
...
# This is the end of the Module Score Calculation in GSE149878
#################################################################################################################